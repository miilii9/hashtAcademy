...
export default function SingleOnline() {
    return (
        <>
            <div className="w-full sm:px-10 md:px-32 flex sm:flex-col md:flex-row sm:mt-10 md:mt-32 justify-center mb-64">
                <div className="flex flex-col sm:w-full md:w-2/5 md:mx-10">
                    ...
                    <div className="text-sm mb-8 leading-7 text-justify">
                        ...
                        نیازلورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با
                        استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در
                        ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز ورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با
                        استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در
                        ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد
                        نیازلورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با
                        استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در
                    ...
                    <div className=" font-base text-lg mb-6">مشاهده جلسه اول</div>
                    <div className="rounded-2xl object-cover overflow-hidden flex justify-center w-full bg-gray-300 sm:mb-20 md:mb-0">
